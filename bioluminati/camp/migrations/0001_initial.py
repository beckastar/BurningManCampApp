    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('diet_lifestyle', models.CharField(blank=True, max_length=200, null=True, choices=[(b'Vegetarian', b'Vegetarian'), (b'Vegan', b'Vegan'), (b'Omnivore', b'Omnivore'), (b'Pescaterian', b'Pescaterian'), (b'Gluten_free', b'Gluten_free')])),
